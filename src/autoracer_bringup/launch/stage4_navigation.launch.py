...
def generate_launch_description():
    ...
    adapter = Node(
        ...
        parameters=[{
            ...
            'min_forward_drive_speed_mps': ParameterValue(LaunchConfiguration('min_forward_drive_speed_mps'), value_type=float),
            'min_reverse_drive_speed_mps': ParameterValue(LaunchConfiguration('min_reverse_drive_speed_mps'), value_type=float),
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('min_forward_drive_speed_mps', default_value='0.35'),
        DeclareLaunchArgument('min_reverse_drive_speed_mps', default_value='0.35'),
